...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.MovieViewHolder> {

    private List<Movie> mMovieList;
    private final Context mContext;
    private final ListItemClickListener mClickListener;

    public ForecastAdapter(Context context, ListItemClickListener clickListener) {
